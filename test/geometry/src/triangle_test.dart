...
void main() {
  ...
  group('Assign TriangleTypes correctly', () {
    ...
    group('Triangles are invalid', () {
      ...
      test(
          'Invalid Triangle type of givenLengths constructor is TriangleType.invalid1',
          () {
  ...
  group('Calculate triangle area correctly based on TriangleTypes', () {
    ...
    group('Triangles are invalid', () {
      ...
      test(
          'Area of invalid givenLengths triangle throws InvalidTriangleException1',
          () {
        expect(() => triangleFromLengthsInvalid1.area,
            throwsA(isA<InvalidTriangleException>()));
      });
      test(
          'Area of invalid givenLengths triangle throws InvalidTriangleException2',
          () {
  ...
  group('Calculate triangle perimeter correctly based on TriangleTypes', () {
    ...
    group('Triangles are invalid', () {
      ...
      test(
          'Perimeter of invalid givenLengths triangle throws InvalidTriangleException1',
          () {
        expect(() => triangleFromLengthsInvalid1.area,
            throwsA(isA<InvalidTriangleException>()));
      });
      test(
          'Perimeter of invalid givenLengths triangle throws InvalidTriangleException2',
          () {
        expect(() => triangleFromLengthsInvalid2.area,
            throwsA(isA<InvalidTriangleException>()));
      });
